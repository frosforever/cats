...
nelSemigroup: cats.Semigroup[cats.data.NonEmptyList[ConfigError]] = cats.SemigroupK$$anon$2@7dcfa87e

scala> implicit val readString: Read[String] = Read.stringRead
readString: Read[String] = Read$$anon$1@5892f696

scala> implicit val readInt: Read[Int] = Read.intRead
readInt: Read[Int] = Read$$anon$2@484048a4
...
scala> implicit val nelSemigroup: Semigroup[NonEmptyList[ConfigError]] =
     |   SemigroupK[NonEmptyList].algebra[ConfigError]
nelSemigroup: cats.Semigroup[cats.data.NonEmptyList[ConfigError]] = cats.SemigroupK$$anon$2@10a0d3fa
